...
function loadContent() {
    ...
    const redirectCreate = document.querySelector('#redirect-create');
    const redirectSignup = document.querySelector('#redirect-signup');
    ...
    function toggleSection() {
        ...
        sectionsEl.style.left = `${target.offsetLeft * -1}px`;
    }
   ...
   // Event Listeners
    ...
    redirectCreate.addEventListener('click', toggleSection)
    redirectSignup.addEventListener('click', toggleSection)
    form.addEventListener('submit', handleFormSubmission);
    form.addEventListener('input', handleInputChanges);
    window.addEventListener('resize', () => sectionsEl.style.left = '0px');
}
